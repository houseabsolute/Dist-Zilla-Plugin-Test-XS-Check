...
https://metacpan.org/release/Dist-Zilla-Plugin-Test-XS-Check

If you use cpanminus, you can do it without downloading the tarball first:

    $ cpanm --reinstall --installdeps --with-recommends Dist::Zilla::Plugin::Test::XS::Check
...
You can also do this via cpanm directly:
    ...
    $ cpanm --reinstall --installdeps --with-develop --with-recommends Dist::Zilla::Plugin::Test::XS::Check
...
The code for this distribution is [hosted at GitHub](https://github.com/autarch/Dist-Zilla-Plugin-Test-XS-Check).
